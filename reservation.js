document.addEventListener('DOMContentLoaded', function () {
    ...
    checkOutReservationBtn.addEventListener('click', function () {
        ...
        const timeSlot = selectedRow.cells[1].textContent; // This is the check-in time
        ...
        tableAvailability[timeSlot][tableIndex] = true;
    ...
    editReservationBtn.addEventListener('click', function () {
        ...
        addBtn.onclick = function (e) {
            ...
            const newTableNumber = parseInt(selectedTable.dataset.tableNumber, 10);
            ...
            // If time slot or table changed, update availability
